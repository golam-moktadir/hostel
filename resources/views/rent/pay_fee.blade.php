...
@section('content')
	    <div class="row">
		    <div class="col-lg-12">
		    	<h3 class="text-center" style="color: #2559ee">Add Hostel Fee</h3>
		    	<hr />
			</div>
	    </div>
         <form action="{{url('insert_rent')}}" method="post" enctype="multipart/form-data">
            {{csrf_field()}}
          <div class="row">  
            ...
            <div class="row">  
                <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                   <div class="form-group">
                        ...
                        <input type="number" class="form-control" name="month_fee" placeholder="Enter Month Fee" required>      
                    </div>                                                         
                </div>
            </div>
            <div class="row">
