...
@section('content')
	    <div class="row">
		    <div class="col-lg-12">
		    	<h3 class="text-center" style="color: #2559ee">Edit Meal Entry</h3>
		    	<hr />
			</div>
	    </div>
         <form action="{{url('update_meal_entry')}}" method="post" enctype="multipart/form-data">
            {{csrf_field()}}
          <div class="row">  
            ...
            <div class="row">  
                <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                    <div class="form-group">
                        <input type="hidden" name="id" value="<?php echo $meal->unique_id ?>">
                        ...
                        <select name="year" class="form-control" required>
                             ...
                             <option value="{{$year}}" {{($year == $meal->year)?'selected':''}}>{{$year}}</option> 
                             @endfor   
                        </select> 
                    </div>                                                        
                </div>
                ...
                <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                    <div class="form-group">
                        ...
                        <select name="month" class="form-control" required>
                             ...
                             <option value="{{$months}}" {{($months == $meal->month)?'selected':''}}>{{$months}}</option> 
                             @endforeach   
                        </select> 
                    </div>                                                         
                </div>
                ...
                <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                    <div class="form-group">
                        ...
                        <select name="days" class="form-control" required>
                             ...
                             <option value="{{$day}}" {{($day == $meal->days)?'selected':''}}>{{$day}}</option> 
                             @endfor    
                        </select> 
                    </div>                                                         
                </div>
                        ...
                        <select name="day_meal" class="form-control">
                            <option value="">--Select--</option>
                                ...
                                @for($i = 1; $i <= 7; $i++)
                                    ...
                                    <option value="{{$i}}" {{($i == $meal->day_meal)?'selected':''}}>{{$i}}</option>
                                @endfor
                        </select>     
                    </div>                                                         
                </div>
