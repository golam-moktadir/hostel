...
@section('content')
	    <div class="row">
		    <div class="col-lg-12">
		    	<h3 class="text-center" style="color: #2559ee">Add Meal Fee</h3>
		    	<hr />
			</div>
	    </div>
         <form action="{{url('meal_fee_insert')}}" method="post" enctype="multipart/form-data">
            {{csrf_field()}}
          <div class="row">  
                ...
                <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                    <div class="form-group">
                        ...
                        <select name="month" class="form-control" required>
                             ...
                             <option value="{{$months}}" {{(date('m') == $key)?'selected':''}}>{{$months}}</option> 
                             @endforeach    
                        </select> 
                    </div>                                                         
                </div>
            ...
            <div class="row">  
                <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                   <div class="form-group">
                        ...
                        <input type="number" class="form-control" name="meal_fee" placeholder="Enter Meal Fee" required>      
                    </div>                                                         
                </div>
            </div>
            <div class="row">
